...
if diag == True:
    ...
    plt.pie([len(spam), len(ham)], labels = ['spam', 'ham'], colors = colors, explode = [0.2, 0],  autopct='%1.1f%%')
    plt.legend()
...
if diag == True:
    ...
    ax0.hist([dataset_spam_count, dataset_ham_count], bins, label=['spam', 'ham'], color= colors)
    decorate_axis(ax0)
